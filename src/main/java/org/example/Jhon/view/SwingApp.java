...
//        employeeRepository = new EmployeeRepository(DatabaseConnection.getInstance());
    ...
    private void refreshEmployeeTable() {
        try{
            ...
            JOptionPane.showMessageDialog(this,
                    "Error al obtener los empleados de la base de datos", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    private void agregarEmpleado() throws SQLException {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, "Empleado agregado correctamente", "Éxito",
    ...
    private void actualizarEmpleado() {
        ...
        String empleadoIdStr = JOptionPane.showInputDialog(this,
                "Ingrese el ID del empleado a actualizar:", "Actualizar Empleado",
        ...
        if (empleadoIdStr != null) {
            try {
                ...
                if (empleado != null) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            "No se encontró ningún empleado con el ID especificado", "Error", JOptionPane.ERROR_MESSAGE);
                }
